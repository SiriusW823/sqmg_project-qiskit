...
─────────────────────────────────────────────────────────────────────────────
  ...
  qc.if_test((CR, 0)) as else_: ...      →  if bit_from_mz: <body>
  qc.measure(q[i], c[j])                 →  c_j = mz(q[i])

重要差異說明
─────────────────────────────────────────────────────────────────────────────
  1. Bit ordering
     - Qiskit：big-endian（bit[0]=最高位）→ post_process 需 reverse=True
     - CUDA-Q：依 mz() 呼叫順序，bit[0]=第一個 mz → reverse=False
...
CUDA-Q 0.7.1 相容性說明
─────────────────────────────────────────────────────────────────────────────
  - @cudaq.kernel 使用 Python AST bridge，支援 if/else、布林運算（or/and）
    作用於 mz() 回傳的 bool 值（古典控制流）
  - if a or b: gate(q) 會被編譯為 Quake MLIR 的 cc.if 節點，0.7.1 支援
  - 半線路測量（mid-circuit measurement）+ 古典回饋：0.7.1 nvidia target 支援
...
def _qmg_dynamic_n9(weights: list[float]):
    """N=9 QMG 動態分子生成電路（CUDA-Q 0.7.1 實作）。"""
    ...
    a1_0 = mz(q[0])
    a1_1 = mz(q[1])    # bits[ 0: 2] 原子 1
    a2_0 = mz(q[2])
    a2_1 = mz(q[3])    # bits[ 2: 4] 原子 2
    ...
    b31_0 = mz(q[4])
    b31_1 = mz(q[5])  # bits[ 8:10] 鍵 3-1
    b32_0 = mz(q[6])
    b32_1 = mz(q[7])  # bits[10:12] 鍵 3-2
    ...
    b41_0 = mz(q[4])
    b41_1 = mz(q[5])  # bits[14:16] 鍵 4-1
    b42_0 = mz(q[6])
    b42_1 = mz(q[7])  # bits[16:18] 鍵 4-2
    b43_0 = mz(q[8])
    b43_1 = mz(q[9])  # bits[18:20] 鍵 4-3
    ...
    b51_0 = mz(q[4])
    b51_1 = mz(q[5])  # bits[22:24] 鍵 5-1
    b52_0 = mz(q[6])
    b52_1 = mz(q[7])  # bits[24:26] 鍵 5-2
    b53_0 = mz(q[8])
    b53_1 = mz(q[9])  # bits[26:28] 鍵 5-3
    b54_0 = mz(q[10])
    b54_1 = mz(q[11]) # bits[28:30] 鍵 5-4
    ...
    b61_0 = mz(q[4])
    b61_1 = mz(q[5])  # bits[32:34] 鍵 6-1
    b62_0 = mz(q[6])
    b62_1 = mz(q[7])  # bits[34:36] 鍵 6-2
    b63_0 = mz(q[8])
    b63_1 = mz(q[9])  # bits[36:38] 鍵 6-3
    b64_0 = mz(q[10])
    b64_1 = mz(q[11]) # bits[38:40] 鍵 6-4
    b65_0 = mz(q[12])
    b65_1 = mz(q[13]) # bits[40:42] 鍵 6-5
    ...
    b71_0 = mz(q[4])
    b71_1 = mz(q[5])  # bits[44:46] 鍵 7-1
    b72_0 = mz(q[6])
    b72_1 = mz(q[7])  # bits[46:48] 鍵 7-2
    b73_0 = mz(q[8])
    b73_1 = mz(q[9])  # bits[48:50] 鍵 7-3
    b74_0 = mz(q[10])
    b74_1 = mz(q[11]) # bits[50:52] 鍵 7-4
    b75_0 = mz(q[12])
    b75_1 = mz(q[13]) # bits[52:54] 鍵 7-5
    b76_0 = mz(q[14])
    b76_1 = mz(q[15]) # bits[54:56] 鍵 7-6
    ...
    b81_0 = mz(q[4])
    b81_1 = mz(q[5])  # bits[58:60] 鍵 8-1
    b82_0 = mz(q[6])
    b82_1 = mz(q[7])  # bits[60:62] 鍵 8-2
    b83_0 = mz(q[8])
    b83_1 = mz(q[9])  # bits[62:64] 鍵 8-3
    b84_0 = mz(q[10])
    b84_1 = mz(q[11]) # bits[64:66] 鍵 8-4
    b85_0 = mz(q[12])
    b85_1 = mz(q[13]) # bits[66:68] 鍵 8-5
    b86_0 = mz(q[14])
    b86_1 = mz(q[15]) # bits[68:70] 鍵 8-6
    b87_0 = mz(q[16])
    b87_1 = mz(q[17]) # bits[70:72] 鍵 8-7
    ...
    a9_0 = mz(q[2])
    a9_1 = mz(q[3])    # bits[72:74] 原子 9

    # 鍵 9-{1..8}：條件 = atom_9_existence（★ 用 a9 而非 a8）
    if a9_0 or a9_1:
    ...
    mz(q[4])
    mz(q[5])   # bits[74:76]  鍵 9-1
    mz(q[6])
    mz(q[7])   # bits[76:78]  鍵 9-2
    mz(q[8])
    mz(q[9])   # bits[78:80]  鍵 9-3
    mz(q[10])
    mz(q[11])  # bits[80:82]  鍵 9-4
    mz(q[12])
    mz(q[13])  # bits[82:84]  鍵 9-5
    mz(q[14])
    mz(q[15])  # bits[84:86]  鍵 9-6
    mz(q[16])
    mz(q[17])  # bits[86:88]  鍵 9-7
    mz(q[18])
    mz(q[19])  # bits[88:90]  鍵 9-8
...
class DynamicCircuitBuilderCUDAQ:
    """
    CUDA-Q 版 QMG 動態電路建構器（CUDA-Q 0.7.1 相容）。
